...
from gym_panda_frite.envs.wrapper_panda_frite_env_ros import WrapperPandaFriteEnvROS
...
def main():
	...
	env = WrapperPandaFriteEnvROS(gym.make(env_name, database=db, json_decoder = json_decoder, env_pybullet=env_pybullet, gui=args.gui))
